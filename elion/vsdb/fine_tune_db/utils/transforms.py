...
def get_index(atom_num, hybridization, is_aromatic, mode):
    if mode == 'basic':
        # print('MAP_ATOM_TYPE_ONLY_TO_INDEX: %s' % MAP_ATOM_TYPE_ONLY_TO_INDEX)
        # print('atom_num: %s' % atom_num)
        # print('atom_num int: %s' % (int(atom_num)))
...
class FeaturizeLigandAtom(object):
    ...
    def __call__(self, data: ProteinLigandData):
        ...
        # print('hybridization_list', hybridization_list)
        # print('aromatic_list', aromatic_list)
        # print('ProteinLigandData', data)
