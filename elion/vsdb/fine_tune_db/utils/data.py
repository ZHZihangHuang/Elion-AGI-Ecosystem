...
class PDBProtein(object):
    ...
    def _parse(self):
        ...
        for atom in self._enum_formatted_atom_lines():
            ...
            # print("atom: %s" % atom)
            # print("atom['res_name']: %s" % atom['res_name'])
            # print('self.AA_NAME_NUMBER: %s' % self.AA_NAME_NUMBER)
            # print("self.AA_NAME_NUMBER atom['res_name']: %s" % self.AA_NAME_NUMBER[atom['res_name']])
